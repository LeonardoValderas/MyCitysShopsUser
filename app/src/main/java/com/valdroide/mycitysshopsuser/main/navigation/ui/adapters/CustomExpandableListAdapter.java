...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter  {
    ...
    private Map<String, List<SubCategory>> mExpandableListDetail;
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        expandedListTextView.setText(expandedListText.getSUBCATEGORY());
        return convertView;
    }
    ...
    public void setList(List<String> expandableListTitle, Map<String, List<SubCategory>> expandableListDetail) {
        mExpandableListTitle = expandableListTitle;
        mExpandableListDetail = expandableListDetail;
